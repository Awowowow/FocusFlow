...
const blank = { originalInput: "", title: "", description: "", priority: "MEDIUM", status: "PENDING" };

export function TaskFormModal({ task, onSave, onClose, saving }) {
  const [form, setForm] = useState(() => task ? { ...blank, ...task, originalInput: task.originalInput ?? "" } : blank);
  ...
  async function improve() {
    ...
    try {
      ...
      toast.success(suggestion.source === "ai" ? "AI suggestion ready" : "Smart suggestion ready");
    } catch (error) {
